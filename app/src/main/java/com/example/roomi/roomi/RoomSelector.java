...
public class RoomSelector extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View kitchenButton = findViewById(R.id.kitchen_button);

        kitchenButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(RoomSelector.this, RoomSettings.class);
                myIntent.putExtra("name", "kitchen");
                RoomSelector.this.startActivity(myIntent);
            }
        });

        View bedroomButton = findViewById(R.id.bedroom_button);

        bedroomButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(RoomSelector.this, RoomSettings.class);
                myIntent.putExtra("name", "bedroom");
                RoomSelector.this.startActivity(myIntent);
            }
        });
